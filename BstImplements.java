...
public class BstImplements {
    ...
    public static void main(String[] args) {
        BstImplements.binarySearchTree tree = new BstImplements.binarySearchTree();
        tree.root = new BstImplements.Node(10);
        tree.insert(7);
        tree.insert(8);
        tree.insert(12);
        tree.insert(11);

        ArrayList<Integer> test = tree.preorderTree(tree.root, 0, new ArrayList<Integer>());
